...
class CommandNOGROUPTestMixin(PipelinesAndSetUps):
...
class CommandTHEREISGROUPOffTestMixin(PipelinesAndSetUps):
...
class CommandTHEREISGROUPOnTestMixin(PipelinesAndSetUps):
